...
return [
    ...
    'new_complaint' => 'Nova reclamação recebida! :id',
    'new_review' => 'Nova avaliação recebida! :id',
    'new_checkout' => 'Novo check-out recebido! :id',
    'new_order' => 'Novo pedido recebido! :id',
    'new_reservation' => 'Nova reserva recebida! :id',
    'attributes' => [
        'user' => 'Utilizador',
        'code' => 'Código',
